...
<form action="{{ route('categories.update', $category) }}" method="POST" enctype="multipart/form-data" class="row g-6">
    @csrf
    @method('PUT')
            ...
            <div class="card-body p-6 d-flex flex-column gap-4">
                ...
                <div>
                    ...
                    <textarea class="form-control @error('description') is-invalid @enderror" 
                              ...
                              name="description" 
                              rows="5"
                              placeholder="Kategori açıklaması">{{ old('description', $category->description) }}</textarea>
                    @error('description')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="card-body p-6 d-flex flex-column gap-4">
                ...
                <div>
                    ...
                    <textarea class="form-control @error('meta_description') is-invalid @enderror" 
                              ...
                              rows="3"
                              placeholder="Meta açıklama">{{ old('meta_description', $category->meta_description) }}</textarea>
                ...
                <div>
                    <div class="form-check form-switch ps-0">
                        ...
                        <input class="form-check-input ms-auto" 
                               ...
                               value="1"
                               {{ old('show_in_top_menu', $category->show_in_top_menu) ? 'checked' : '' }}>
                    </div>
                </div>
